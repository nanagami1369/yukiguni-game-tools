...
export const formatGoogleCalenderUrl = (dateTime: Temporal.ZonedDateTime): string => {
    ...
    return `https://calendar.google.com/calendar/u/0/r/eventedit?dates=${new String(start.year).padStart(4, '0')}${new String(start.month).padStart(2, '0')}${new String(start.day).padStart(2, '0')}T${new String(start.hour).padStart(2, '0')}${new String(start.minute).padStart(2, '0')}${new String(start.second).padStart(2, '0')}/${new String(end.year).padStart(4, '0')}${new String(end.month).padStart(2, '0')}${new String(end.day).padStart(2, '0')}T${new String(end.hour).padStart(2, '0')}${new String(end.minute).padStart(2, '0')}${new String(end.second).padStart(2, '0')}`
}
